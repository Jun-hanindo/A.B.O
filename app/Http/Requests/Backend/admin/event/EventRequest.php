    ...
    public function rules()
    {
        ...
        $event = Event::find($req['event_id']);
            ...
            $rules =  [
                ...
                'description'       => 'required',
                //'schedule_info'        => 'required',
                'featured_image1'   => 'required|image|mimes:jpg,jpeg|dimensions:width=2880,height=1000|max:1000',
                'featured_image2'   => 'required|image|mimes:jpg,jpeg|dimensions:width=1125,height=762|max:1000',
                'featured_image3'   => 'required|image|mimes:jpg,jpeg|dimensions:width=300,height=200|max:1000',
                'share_image'       => 'required|image|mimes:jpg,jpeg|dimensions:width=1200,height=630|max:1000',
                'seat_image'        => 'image|mimes:jpg,jpeg|max:1000',
                'seat_image2'        => 'image|mimes:jpg,jpeg|max:1000',
                'seat_image2'        => 'image|mimes:jpg,jpeg|max:1000',
                'buylink'           => 'required|url',
