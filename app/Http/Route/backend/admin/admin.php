...
Route::group(['prefix' => 'admin', 'middleware' => 'sentinel_auth', 'namespace' => 'Backend\Admin'], function () {
    ...
    Route::group(['prefix' => 'tixtrack','namespace' => 'TixTrack'], function () {
        ...
        Route::get('transaction', array('as' => 'admin-tixtrack-change-account', 'uses' => 'TransactionsController@account'));
        Route::put('swap-account', array('as' => 'admin-tixtrack-swap-account', 'uses' => 'TransactionsController@swapAccount'));
        Route::post('update-data-transaction', array('as' => 'admin-tixtrack-update-data-transaction', 'uses' => 'TransactionsController@updateData'));
        ...
        Route::get('chart-promotion', array('as' => 'admin-report-tixtrack-chart-promotion', 'uses' => 'ReportsController@chartPromotion'));

        Route::post('chart-image', array('as' => 'admin-report-tixtrack-image', 'uses' => 'ReportsController@chartImage'));
    ...
    Route::group(['prefix' => 'visa-checkout'], function () {
        ...
        Route::post('update-sort', array('as' => 'admin-visa-checkout-sort-order', 'uses' => 'VisaCheckoutsController@updateSortOrder'));
    });
});
