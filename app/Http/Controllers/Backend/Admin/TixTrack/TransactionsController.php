...
class TransactionsController extends BaseController
{
    ...
    //         $accounts = $modelAccount->dropdownByLogin($loginAccount->id);
    //         $data['accounts'] = $accounts;
    //         //\Session::flash('login_success', trans('Login success!'));
    //         //flash()->success('Login success!');

    //         return view('backend.admin.tixtrack.update_transaction', $data);
    //     }else{
    //         //\Session::flash('login_failed', trans('The user name or password provided is incorrect.'));
    //         //flash()->error('The user name or password provided is incorrect.');
    //         return view('backend.admin.tixtrack.update_transaction');
    //     }
    // }
