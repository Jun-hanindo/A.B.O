...
if (! function_exists('rand_color2')) {
    ...
    function rand_color2($number) {
        ...
        $color = ['#5d8aa8', '#e32636', '#ffbf00', '#a4c639', '#cd9575', '#008000', '#00ffff', '#e9d66b', '#ff9966', '#a52a2a',
                  '#007fff', '#87a96b', '#d19fe8', '#3d2b1f', '#8a2be2', '#66ff00', '#deb887', '#cc0000', '#4b3621', '#0047ab',
                  '#85bb65', '#ccff00', '#996515', '#663854', '#ed872d', '#5d8aa8', '#e32636', '#e9d66b', '#a4c639', '#cd9575', 
                  '#008000', '#00ffff', '#ffbf00', '#ff9966', '#a52a2a', '#007fff', '#87a96b', '#848482', '#3d2b1f', '#8a2be2', 
                  '#66ff00', '#deb887', '#cc0000', '#4b3621', '#0047ab', '#85bb65', '#ccff00', '#996515', '#a99a86', '#ed872d'];
        return $color[$number];
    }
}
