<ul>
    ...
    {{-- <li class="sidebar-menu {{ (Request::url() == URL::route('terms-and-conditions')) ? 'active' : '' }}">
        <a href="{{URL::route('terms-and-conditions')}}">{{ trans('frontend/general.terms_and_conditions') }}</a>
    </li> --}}
