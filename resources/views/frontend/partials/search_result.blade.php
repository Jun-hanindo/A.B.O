            ...
            <div class="sidebar sidebar-search">
                <ul>
                    ...
                    <li class="sidebar-head">
                        ...
                        <a href="javascript:void(0)" class="reset-filter"  style="{{ ($venue_sel != 'all' || (count($cats_sel) > 0 && !empty($cats_sel))) ? '' : 'display:none;' }}"><i class="fa fa-undo"></i> {{ trans('frontend/general.reset') }} </a>
                    </li>
            ...
            <div class="container">
                <div class="mobile-sidebar-menu">
                    <a class="menu collapsed" role="button" data-toggle="collapse" href="#mobile-sidebar-collapse" aria-expanded="false" aria-controls="collapseExample">{{ trans('frontend/general.filters') }}</a>
                        <a href="javascript:void(0)" class="reset-filter" style="{{ ($venue_sel != 'all' || (count($cats_sel) > 0 && !empty($cats_sel))) ? '' : 'display:none;' }}"><i class="fa fa-undo"></i> Reset </a>
