        ...
        <div class="container">
            ...
            <div class="moreDetail">
                <a href="{{ $event->buylink }}" target="_blank">
                    @if($event->buy_button_disabled == true)
                        <button class="btn btnDetail font-bold" disabled>{{ $event->buy_button_disabled_message }}</button>
                    @else
        ...
        <div class="col-md-12">
            <div class="container">
                <ul class="" role="">
                    ...
                    @endif
                    <li><a href="{{ $event->buylink }}" target="_blank">
                        @if($event->buy_button_disabled == true)
                            <button class="btn btnBuy btnABO font-bold" disabled>{{ $event->buy_button_disabled_message }}</button>
                        @else
                                                            ...
                                                            <section id="promotion" class="sectionEvent">
                                                                ...
                                                                <h3 class="font-bold">{{ $promotion->title }}</h3>
                                                                    ...
                                                                    @if(!empty($promotion->link_title_more_description))
                                                                        <a id="link_title_more_promotion" data-toggle="collapse" href="#more_description" aria-expanded="false"><u> {!! $promotion->link_title_more_description !!} </u></a>
                                                                    @endif
