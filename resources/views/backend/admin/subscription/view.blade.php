...
@section('title')
    {{ trans('backend/general.subscription') }}
@endsection
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">{{ trans('backend/general.subscription_detail') }} </h3>
                </div>
                <div class="box-body">
                    <form class="">
                        <div class="error"></div>
                        ...
                        <div class="form-group pull-left full-width">
                            {!! Form::label('subject', trans('backend/general.first_name'), ['class' => 'col-sm-3 control-label']) !!}
                            <div class="col-sm-9">
                                <div class="form-control no-border nopadding">: {{ $data->first_name }}</div>
                            </div>
                        </div>
                        <div class="form-group pull-left full-width">
                            {!! Form::label('name', trans('backend/general.last_name'), ['class' => 'col-sm-3 control-label']) !!}
                            <div class="col-sm-9">
                                <div class="form-control no-border nopadding">: {{ $data->last_name }}</div>
                            </div>
                        </div>
                        <div class="form-group pull-left full-width">
                            {!! Form::label('email', trans('backend/general.contact_number'), ['class' => 'col-sm-3 control-label']) !!}
                            <div class="col-sm-9">
                                <div class="form-control no-border nopadding">: {{ $data->country_code.' '.$data->contact_number }}</div>
                            </div>
                        </div>
                        <div class="form-group pull-left full-width">
                            {!! Form::label('contact_number', trans('backend/general.event'), ['class' => 'col-sm-3 control-label']) !!}
                        </div>
                ...
                <div class="box-footer">
                    <a href="{{ route('admin-index-subscription') }}" class="btn btn-default">{{ trans('backend/general.button_back') }}</a>
                </div>
            </div>
        </div>
    </div>
