    ...
    function savePdf(event_id, start_date, end_date){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#preview-body').html('<iframe id="pdf-frame" src="http://docs.google.com/gview?url='+response.data+'&embedded=true&chrome=true" style="width:850px; height:600px;" frameborder="0"></iframe>');
