@section('scripts')
    ...
    $('#modal-preview').on('show.bs.modal', function (e) {
        ...
        $('#preview-body').html('<iframe id="pdf-frame" src="http://docs.google.com/gview?url='+pdf+'&embedded=true&headers=true" style="width:850px; height:600px;" frameborder="0"></iframe>');
    });
