                ...
                {!! Form::open(array('url' => route('admin-post-update-manage-page', $slug),'method'=>'POST','id'=>'form-manage-page')) !!}
                    <div class="box-body">
                        ...
                        <div class="form-group{{ Form::hasError('content') }} content">
                            {!! Form::textarea('content', $content, ['id' => 'content', 'class' => 'form-control tinymce','rows'=>'15']) !!}
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{ URL::to($slug.'?preview=true') }}" target="_blank" id="button_preview" class="btn btn-default {{ ($status == '') ? 'disabled' : '' }}" title="{{ trans('general.button_preview') }}">{{ trans('general.button_preview') }}</a>
