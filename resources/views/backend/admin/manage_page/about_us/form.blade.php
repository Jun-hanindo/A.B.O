        ...
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {!! Form::open(array('url' => route('admin-post-update-about-us'),'method'=>'POST','id'=>'form-about-us')) !!}
                    <div class="box-body">
                        <div class="error"></div>
                        <input type="hidden" name="slug" class="form-control" id="slug" value="our-company">
                    ...
                    <div class="box-footer">
                        <a href="{{ route('admin-about-us') }}" class="btn btn-default">{{ trans('general.button_cancel') }}</a>
