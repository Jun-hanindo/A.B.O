...
@section('title')
    {{ trans('general.provinces') }} {{ trans('general.management') }} - {{ trans('general.create_new') }}
@endsection

@section('page-header')
    {{ trans('general.provinces') }} {{ trans('general.management') }} <small>{{trans('general.create_new')}}</small>
@endsection
