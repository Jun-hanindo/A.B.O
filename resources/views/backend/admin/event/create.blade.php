    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-primary">
                ...
                {!! Form::open(array('url' => route('admin-post-event'),'method'=>'POST','id'=>'form-event')) !!}
                    <div class="box-body">
                        <div class="error"></div>
                        <div class="col-md-9">
                            <div class="form-group{{ Form::hasError('title') }} title">
                                {!! Form::label('title', trans('general.title')) !!}
                                {!! Form::text('title', old('title'), ['class' => 'form-control','maxlength'=>'255']) !!}
                                {!! Form::errorMsg('title') !!}
                            </div>
                            <div class="form-group{{ Form::hasError('description') }} description">
                                {!! Form::label('description', trans('general.description')) !!}
                                {!! Form::textarea('description', old('description'), ['class' => 'form-control', 'rows'=> '12']) !!}
                            ...
                            <div class="form-group{{ Form::hasError('addmition_rules') }} addmition_rules">
                                ...
                                {!! Form::textarea('addmition_rules', old('addmition_rules'), ['class' => 'form-control', 'rows'=> '7']) !!}
                            </div>
                            <div class="form-group{{ Form::hasError('price_info') }} price_info">
                                {!! Form::label('price_info', trans('general.price_info')) !!}
                                {!! Form::textarea('price_info', old('price_info'), ['class' => 'form-control', 'rows'=> '5']) !!}
                            </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group{{ Form::hasError('slide_image') }} slide_image">
                                ...
                                {!! Form::file('slide_image', old('slide_image'), ['class' => 'form-control']) !!}
                            </div>
                            <div class="form-group{{ Form::hasError('thumbnail_image') }} thumbnail_image">
                                ...
                                {!! Form::file('thumbnail_image', old('thumbnail_image'), ['class' => 'form-control']) !!}
                            </div>
                            ...
                            <div class="form-group{{ Form::hasError('buy_button_link') }} buy_button_link">
                                ...
                                {!! Form::text('buy_button_link', old('buy_button_link'), ['class' => 'form-control','maxlength'=>'255']) !!}
                            </div>
