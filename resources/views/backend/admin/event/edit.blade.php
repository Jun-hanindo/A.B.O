                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group{{ Form::hasError('schedule_info') }} schedule_info">
                                ...
                                {!! Form::textarea('schedule_info', $data->price_info, ['class' => 'form-control tinymce', 'rows'=> '7', 'placeholder' => trans('general.schedule_info')]) !!}
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group{{ Form::hasError('event_type') }} event_type">
                                ...
                                <input type="checkbox" name="event_type" class="form-control event_type-check" data-animate="false" data-on-text="General" data-off-color="success" data-off-text="Seated" {{$data['checked']}}>
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <form id="form-event-promotion">
                        <input type="hidden" name="id" class="form-control" id="promotion_id">
                            <div class="form-group{{ Form::hasError('title') }} title">
                                {!! Form::label('title', trans('general.title').' *') !!}
                                {!! Form::text('title', old('title'), ['id' => 'title-promo', 'class' => 'form-control','maxlength'=>'255', 'placeholder' => trans('general.title')]) !!}
                                {!! Form::errorMsg('title') !!}
                            </div>
                            <div class="form-group{{ Form::hasError('description') }} description">
                                {!! Form::label('description', trans('general.description').' *') !!}
                                {!! Form::textarea('description', old('description'), ['id' => 'description-promo', 'class' => 'form-control tinymce', 'rows'=> '5', 'placeholder' => trans('general.description')]) !!}
                                {!! Form::errorMsg('description') !!}
                            </div>
