                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-9">
                            ...
                            <div class="form-group{{ Form::hasError('title_meta_tag') }} title_meta_tag">
                                ...
                                {!! Form::text('title_meta_tag', $data->title_meta_tag, ['class' => 'form-control','maxlength'=>'255', 'placeholder' => trans('general.title_meta_tag')]) !!}
                            ...
                            <div class="form-group{{ Form::hasError('description_meta_tag') }} description_meta_tag">
                                ...
                                {!! Form::textarea('description_meta_tag', $data->description_meta_tag, ['rows' => 5, 'class' => 'form-control', 'placeholder' => trans('general.description_meta_tag')]) !!}
                            ...
                            <div class="form-group{{ Form::hasError('keywords_meta_tag') }} keywords_meta_tag">
                                ...
                                {!! Form::textarea('keywords_meta_tag', $data->keywords_meta_tag, ['rows' => 5, 'class' => 'form-control', 'placeholder' => trans('general.keywords_meta_tag')]) !!}
                            ...
                            <div class="form-group{{ Form::hasError('ga_tracking_code') }} ga_tracking_code">
                                ...
                                {!! Form::textarea('ga_tracking_code', $data->ga_tracking_code, ['rows' => 5, 'class' => 'form-control', 'placeholder' => trans('general.ga_tracking_code')]) !!}
                            ...
                            <div class="form-group{{ Form::hasError('ga_conversion_code') }} ga_conversion_code">
                                ...
                                {!! Form::textarea('ga_conversion_code', $data->ga_conversion_code, ['rows' => 5, 'class' => 'form-control', 'placeholder' => trans('general.ga_conversion_code')]) !!}
                            ...
                            <div class="form-group{{ Form::hasError('fp_tracking_code') }} fp_tracking_code">
                                ...
                                {!! Form::textarea('fp_tracking_code', $data->fp_tracking_code, ['rows' => 5, 'class' => 'form-control', 'placeholder' => trans('general.fp_tracking_code')]) !!}
                            ...
                            <div class="form-group{{ Form::hasError('fp_conversion_code') }} fp_conversion_code">
                                ...
                                {!! Form::textarea('fp_conversion_code', $data->fp_conversion_code, ['rows' => 5, 'class' => 'form-control', 'placeholder' => trans('general.fp_conversion_code')]) !!}
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group{{ Form::hasError('event_id_tixtrack') }} event_id_tixtrack">
                                ...
                                {!! Form::text('event_id_tixtrack', $data->event_id_tixtrack, ['id' => 'event_id_tixtrack', 'class' => 'form-control number-only','maxlength'=>'255', 'placeholder' => trans('general.event_id_tixtrack')]) !!}
                                {!! Form::errorMsg('event_id_tixtrack') !!}
                            </div>
                            <div class="box-footer">
                                <input class="btn btn-primary pull-right pull-right" title="{{ trans('general.button_save') }}" type="submit" value="{{ trans('general.button_publish') }}" id="button_submit">
                    ...
                    <form id="form-event-promotion">
                        <input type="hidden" name="id" class="form-control" id="promotion_id">
                            ...
                            <div class="form-group{{ Form::hasError('image_link') }} image_link">
                                {!! Form::label('image_link', trans('general.image_link')) !!}
                                {!! Form::text('image_link', old('image_link'), ['id' => 'image_link', 'class' => 'form-control','maxlength'=>'255', 'placeholder' => trans('general.image_link')]) !!}
