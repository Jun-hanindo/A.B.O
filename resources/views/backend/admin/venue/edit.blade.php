...
@section('title')
    {{ trans('general.venues') }} - {{ trans('general.edit') }} {{ trans('general.venue') }}
@endsection
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">{{ trans('general.edit') }} {{ trans('general.venue') }}</h3>
                </div>
                {!! Form::open(array('url' => route('admin-update-venue',$id),'method'=>'POST','id'=>'form-venue')) !!}
                    <div class="box-body">
                        <div class="error"></div>
                        <div class="col-md-9">
                            ...
                            <div class="form-group{{ Form::hasError('venue_name') }} venue_name">
                                ...
                                {!! Form::text('venue_name', $data->venue_name, ['class' => 'form-control','maxlength'=>'255']) !!}
                            ...
                            <div class="form-group{{ Form::hasError('description') }} description">
                                ...
                                {!! Form::textarea('description', $data->description, ['class' => 'form-control', 'rows'=> '5']) !!}
                            ...
                            <div class="form-group{{ Form::hasError('getting_to_venue_by_mrt') }} getting_to_venue_by_mrt">
                                ...
                                {!! Form::textarea('getting_to_venue_by_mrt', $data->getting_to_venue_by_mrt, ['class' => 'form-control', 'rows'=> '5']) !!}
                            </div>
                            <div class="form-group{{ Form::hasError('getting_to_venue_by_car') }} getting_to_venue_by_car">
                                ...
                                {!! Form::textarea('getting_to_venue_by_car', $data->getting_to_venue_by_car, ['class' => 'form-control', 'rows'=> '5']) !!}
                            </div>
                            <div class="form-group{{ Form::hasError('getting_to_venue_by_taxi_uber') }} getting_to_venue_by_taxi_uber">
                                ...
                                {!! Form::textarea('getting_to_venue_by_taxi_uber', $data->getting_to_venue_by_taxi_uber, ['class' => 'form-control', 'rows'=> '5']) !!}
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group{{ Form::hasError('link_map') }} link_map">
                                {!! Form::label('link_map', trans('general.link_map')) !!}
                                {!! Form::text('link_map', $data->link_map, ['class' => 'form-control','maxlength'=>'255']) !!}
                            </div>
                            <div class="form-group{{ Form::hasError('google_maps') }} google_maps">
                                {!! Form::label('google_maps', trans('general.google_maps')) !!}
                                {!! Form::text('google_maps', $data->google_maps, ['class' => 'form-control','maxlength'=>'255']) !!}
                            </div>
