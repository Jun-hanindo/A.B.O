...
@section('content')
    <div class="box box-primary">
        <div class="box-header">
            <h3 class="box-title">{{ trans('backend/general.venues') }}</h3>
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('admin-create-venue') }}" title="{{ trans('backend/general.create_new') }}"><i class="fa fa-plus fa-fw"></i></a>
            </div>
        </div>
        <div class="box-body">
                ...
                <table id="venue-datatables" class="table table-hover table-bordered table-condensed table-responsive datatables" data-tables="true">
                    <thead>
                        <tr>
                            ...
                            <th class="center-align">{{ trans('backend/general.venue_title') }}</th>
                            <th class="center-align">{{ trans('backend/general.address') }}</th>
