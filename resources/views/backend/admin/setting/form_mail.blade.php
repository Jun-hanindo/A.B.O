                ...
                {!! Form::open(array('url' => route('admin-update-setting'),'method'=>'POST','id'=>'form-setting', 'class' => "form-horizontal")) !!}
                    <div class="box-body">
                        ...
                        <div class="form-group{{ Form::hasError('setting.mail_encryption') }} setting.mail_encryption" id="div_mail_encryption">
                            {!! Form::label('mail_encryption', trans('general.mail_encryption').' *', ['class' => 'col-sm-3 control-label']) !!}
                            <div class="col-sm-9">
                                {!! Form::text('setting[mail_encryption]', isset($data['mail_encryption']) ? $data['mail_encryption'] : null, ['class' => 'form-control', 'placeholder' => trans('general.mail_encryption')]) !!}
